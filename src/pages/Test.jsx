...
const Marquee = () => {
  ...
  useLayoutEffect(() => {
    let ctx = gsap.context(() => {
      // 1. Initialize the infinite loop
      tween.current = gsap
  ...
  return (
    <div className="w-full h-24 bg-purple-600 overflow-hidden flex items-center relative border-y border-black/10">
      <div
        ref={scrollingText}
