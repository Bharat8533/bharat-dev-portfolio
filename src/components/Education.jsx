    ...
    <section ref={containerRef} className="py-12 px-6 md:px-12 bg-white">
      <div className="w-full mx-auto">
        ...
        <div className="mb-24 gap-6">
          <h2 className="text-6xl md:text-8xl uppercase font-black leading-none font-sans mb-4">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {educationData.map((edu, index) => (
              <div
                key={index}
                className="edu-card group relative p-1 bg-[#fbfbfb] border border-purple-300 rounded-[2.5rem] overflow-hidden transition-all duration-500 hover:shadow-[0_30px_60px_-15px_rgba(157,60,255,0.1)] hover:border-purple-600 cursor-pointer"
              >
