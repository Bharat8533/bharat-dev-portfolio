    ...
    <nav className="w-full border-b border-gray-200" >
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto h-16">
        <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <span className="logo self-center text-2xl font-semibold whitespace-nowrap tracking-tighter p-2 pt-4">Bharat</span>
        </Link>
        <div className="flex pt-4 p-2 items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        ...
        <div className={`items-center justify-between ${display === true ? 'block' : 'hidden' } w-full h-full md:flex md:w-auto md:order-1 md:mt-0`} style={{zIndex: '1200'}} id="navbar-sticky">
          <ul className="flex flex-col items-center
           md:p-0 font-medium border border-gray-100 bg-white md:space-x-8 rtl:space-x-reverse md:flex-row md:border-0 md:bg-transparent h-fit w-full">
            {
