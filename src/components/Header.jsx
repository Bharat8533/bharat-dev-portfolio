...
const AmazingHeader = () => {
  ...
  return (
    <>
      <header className="fixed top-0 w-full px-4 sm:px-8 py-2 md:px-20 transition-all duration-500 backdrop-blur-sm bg-blend-hard-light z-50">
        <div className="max-w-[1920px] mx-auto grid grid-cols-2 lg:grid-cols-3 items-center">
          {/* LEFT: THE STATEMENT LOGO */}
          <div className="flex justify-start">
            <Link to="/" className="group flex items-center">
              <span className="text-3xl sm:text-4xl md:text-5xl font-[1000] tracking-[-0.08em] uppercase leading-none">
                BHA
              ...
              <div className="w-2 h-2 bg-purple-600 rounded-full mt-3 sm:mt-4 ml-1 group-hover:scale-[2.5] transition-transform duration-500"></div>
            </Link>
          </div>
          ...
          <div className="hidden lg:flex justify-center">
            ...
            <div className="flex items-center gap-2 px-3 py-2 bg-white/70 backdrop-blur-2xl border border-gray-100 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.04)]">
              ...
              <div className="flex items-center gap-1">
                {[
                  ...
                  <React.Fragment key={index}>
                    <a
                      href="#"
                      className="group/item relative w-10 h-10 lg:w-12 lg:h-12 flex items-center justify-center rounded-xl transition-all duration-500 hover:bg-black"
                    >
          ...
          <div className="flex justify-end items-center gap-4 sm:gap-8">
            ...
            <button
              ...
              className="relative w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 flex items-center justify-center bg-black text-white rounded-full group overflow-hidden transition-all duration-500 hover:shadow-2xl active:scale-90"
            >
              <HiOutlineMenuAlt4
                className="relative z-10 text-2xl sm:text-3xl group-hover:rotate-180 transition-transform duration-500"
              />
      ...
      >
        ...
        <button
          ...
          className="absolute top-6 right-6 sm:top-10 sm:right-10 w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 z-50"
        >
          <div className="w-full h-full border border-white/10 rounded-full flex items-center justify-center text-white hover:bg-purple-600 transition-all relative">
            <HiX className="text-2xl sm:text-3xl md:text-4xl" />
          </div>
        </button>

        <div className="h-full flex flex-col md:flex-row items-center justify-between px-6 sm:px-12 md:px-24 py-20 overflow-y-auto relative z-10">
          {/* Main Navigation */}
            ...
            {links.map((link, index) => (
              <div key={index} className="overflow-hidden group">
                <Link
                  ...
                  onClick={() => setMenuOpen(false)}
                  className={`flex items-baseline gap-4 sm:gap-8 py-2 transition-all duration-[800ms] ease-out ${menuOpen ? "translate-y-0 opacity-100" : "translate-y-full opacity-0"}`}
                  style={{
                    transitionDelay: `${menuOpen ? 400 + index * 100 : 0}ms`,
                  }}
                >
                  <span className="text-purple-600 font-mono text-base sm:text-xl font-bold italic">
                    0{index + 1}
                  </span>
                  <h2 className="text-4xl sm:text-6xl md:text-[8vw] font-black uppercase tracking-tighter leading-none text-white/40 group-hover:text-white group-hover:italic group-hover:tracking-normal transition-all duration-500">
                    {link.name}
                  </h2>
                </Link>
              </div>
          ...
          >
            <div className="space-y-4">
              ...
              <div className="flex flex-col text-2xl lg:text-3xl font-bold text-white space-y-2">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl lg:text-3xl font-bold text-white border-b-2 border-purple-600 pb-2">
        ...
        {/* Bottom Metadata */}
        <div className="absolute bottom-6 sm:bottom-12 left-6 sm:left-10 md:left-24 flex gap-6 sm:gap-12 text-[9px] sm:text-[10px] font-black uppercase tracking-[0.3em] sm:tracking-[0.5em] text-white/20">
